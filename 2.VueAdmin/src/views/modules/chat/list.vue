        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#fff","borderRadius":"0px","background":"rgba(64, 158, 255, 1)","clipPath":"polygon(0% 0%, 95% 0, 100% 50%, 95% 100%, 0% 100%)","width":"auto","fontSize":"inherit","height":"32px"}'
                size="small"
