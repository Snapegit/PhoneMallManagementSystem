<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20231121/4577495c378443ad95aab1ad5fe253e2.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"flex-end"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0 100px","borderRadius":"0","background":"#fff","width":"40%","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 auto 20px","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"22px","textShadow":"none","fontWeight":"500"}'>基于SSM的手机商城管理系统的设计与实现注册</p></div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="lianxifangshi">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('lianxifangshi')?'required':''">联系方式：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiamingcheng">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiamingcheng')?'required':''">商家名称：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiatupian">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiatupian')?'required':''">商家图片：</div>
                <file-upload
					tip="点击上传商家图片"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="lianxiren">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('lianxiren')?'required':''">联系人：</div>
				<el-input v-model="registerForm.lianxiren"  placeholder="请输入联系人" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="lianxidianhua">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('lianxidianhua')?'required':''">联系电话：</div>
				<el-input v-model="registerForm.lianxidianhua"  placeholder="请输入联系电话" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="youxiang">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('youxiang')?'required':''">邮箱：</div>
				<el-input v-model="registerForm.youxiang"  placeholder="请输入邮箱" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="yingyezhizhao">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('yingyezhizhao')?'required':''">营业执照：</div>
                <file-upload
					tip="点击上传营业执照"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="shangjiadizhi">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('shangjiadizhi')?'required':''">商家地址：</div>
				<el-input v-model="registerForm.shangjiadizhi"  placeholder="请输入商家地址" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='shangjia'" prop="xiangxijieshao">
				<div v-if="true" :style='{"width":"120px","padding":"0 5px 0 0","lineHeight":"44px","fontSize":"14px","color":"#000","textAlign":"center"}' :class="changeRules('xiangxijieshao')?'required':''">详细介绍：</div>
			    <editor
			        :style='{"width":"100%","height":"auto"}'
			        v-model="registerForm.xiangxijieshao" 
			        class="editor" 
			        action="file/upload">
			    </editor>
			</el-form-item>
...
export default {
	...
	mounted() {
		if(this.$route.query.pageFlag=='register'){
			...
			if ('shangjia' == this.tableName) {
				this.requiredRules.shangjiatupian = [{ required: true, message: '请输入商家图片', trigger: 'blur' }]
			}
		}
	},
    created() {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            var url=this.tableName+"/register";
              ...
              if(`shangjia` == this.tableName && (this.registerForm.mima).toString().length<3){
                this.$message.error('密码长度不能小于3');
                return
              }
              if(`shangjia` == this.tableName && (this.registerForm.mima).toString().length>13){
                this.$message.error('密码长度不能大于13');
                return
              }
				if((!this.registerForm.shangjiatupian) && `shangjia` == this.tableName){
					...
					if(`shangjia` == this.tableName && this.registerForm.youxiang &&(!this.$validate.isEmail2(this.registerForm.youxiang))){
